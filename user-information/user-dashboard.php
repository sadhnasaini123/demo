...
<body>
    ...
    <div class="main-content">
        <div class="dashboard-header">
            <h2>Welcome Back, Sadhna</h2>
            <p class="welcome-text">Here's what's happening with your mining account today</p>
            
            <div class="stats-container">
                <div class="stat-card">
                    <h3>Total Profit</h3>
                    <div class="value">$1,245.89</div>
                ...
                <div class="stat-card">
                    <h3>Mining Profit</h3>
                    <div class="value">$856.32</div>
                    <div class="change positive">
                        <i class="fas fa-arrow-up"></i> 8.7% this month
                    </div>
                </div>
                <div class="stat-card">
                    <h3>Level Income</h3>
                    <div class="value">$389.57</div>
            ...
            <!-- Add this inside your main-content div, after the dashboard-header -->
<div class="mining-summary">
    <div class="summary-card">
        <h3 class="summary-title">Mining Account Summary</h3>
        ...
        <div class="backscenes-setup">
            <h4>Backscenes Setup</h4>
            <div class="balance-item">
                <div class="balance-amount">$0.00</div>
                <div class="balance-label">Testing with Balance</div>
            </div>
            <div class="balance-item">
                <div class="balance-amount">$0.00</div>
                <div class="balance-label">Business Value Balance</div>
            </div>
        </div>
    </div>
    
    <div class="summary-card">
        <h4 class="levels-title">Levels Information</h4>
    ...
    <div class="summary-card">
        <h4 class="portfolio-title">Total Portfolio</h4>
        <div class="portfolio-grid">
            <div class="portfolio-item">
                <div class="portfolio-label">Total Volume</div>
                <div class="portfolio-sub">Package:</div>
                <div class="portfolio-value">$0.00</div>
            </div>
            <div class="portfolio-item">
                <div class="portfolio-label">Direct Volume</div>
                <div class="portfolio-sub">Operating:</div>
                <div class="portfolio-value">$0.00</div>
            </div>
            <div class="portfolio-item">
                <div class="portfolio-label">Self Volume</div>
                <div class="portfolio-sub">Current Value:</div>
                <div class="portfolio-value">$0.00</div>
            </div>
            <div class="portfolio-item">
                <div class="portfolio-label">Total Team</div>
                <div class="portfolio-sub">Active:</div>
                <div class="portfolio-value">0</div>
            </div>
            <div class="portfolio-item">
                <div class="portfolio-label">Direct Team</div>
                <div class="portfolio-sub">Active:</div>
                <div class="portfolio-value">0</div>
            </div>
        </div>
        ...
        <div class="external-link">
            <span>Your External Link: </span>
            <a href="https://basamine.onlinel/accounts/register/?scheme=225423" target="_blank">https://basamine.onlinel/accounts/register/?scheme=225423</a>
        </div>
    </div>
</div>
        </div>
